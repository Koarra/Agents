...
def _extract_keywords(scenario: dict) -> list:
    ...
    keyword_patterns = {
        ...
        "shipping": ["shipping", "maritime", "tanker", "cargo", "container ship", "bulk carrier",
                     "vessel", "port", "freight", "maritime shipping", "international shipping",
                     "sea transport", "ocean freight", "shipowner", "charter"],
        "sensitive_intermediaries": ["intermediary", "broker", "consultant", "lobbyist", "adviser",
                                     "licensing agent", "sales representative", "government adviser",
                                     "public adviser", "consultancy", "lobbying", "brokerage"],
        "sensitive_charities": ["charity", "charitable", "non-profit", "nonprofit", "npo", "ngo",
                                "foundation", "donation", "donor", "fundraising", "philanthropy",
                                "humanitarian", "relief", "welfare", "community development"],
        "religious_entities": ["religious", "religion", "church", "mosque", "temple", "synagogue",
                               "clergy", "priest", "pastor", "imam", "rabbi", "minister",
                               "faith-based", "worship", "congregation", "diocese", "parish"],
        "public_construction": ["government construction", "public infrastructure", "public services",
                                "government contract", "public building", "infrastructure project",
                                "road construction", "railway", "bridge", "tunnel", "airport",
                                "water supply", "sewage", "electrical grid", "waste management",
                                "military base", "court building", "public works", "procurement"],
        "gambling_activities": ["gambling", "casino", "betting", "bookmaker", "slot machine",
                                "online gambling", "online casino", "online betting", "poker",
                                "sports betting", "lottery", "gaming", "wagering", "gambling software",
                                "gambling platform", "iGaming", "sportsbook"],
        "agent_sport": ["sports", "sport agent", "sports agency", "sports federation", "sports club",
                        "professional sports", "athlete", "sports marketing", "broadcasting rights",
                        "sports broadcasting", "sports event", "sports personality", "FIFA", "UEFA",
                        "IOC", "sports competition", "sports organization", "sports rights"],
    }
