"""
Main Entry Point for SIAP Compliance Detection System.
...
def demo_single_document():
    ...
    print("\n" + "=" * 70)
    print("PROCESSING DOCUMENT FROM documents_test/")
    print("=" * 70)
...
def demo_all_documents():
    ...
    print("\n" + "=" * 70)
    print("BATCH PROCESSING ALL DOCUMENTS FROM documents_test/")
    print("=" * 70)
